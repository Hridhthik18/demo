...
select e.employee_id,e.first_name,e.last_name,jh.end_date from employees as e inner join job_history as jh on e.employee_id=jh.employee_id where jh.end_date='1999-12-31';

-- task5
select * from employees;
select * from departments;
select employee_id,first_name,department_name,year(curdate())-year(e.hire_date) as tottal_exp from employees as e inner join departments as d where year(curdate())-year(e.hire_date) >25; 
